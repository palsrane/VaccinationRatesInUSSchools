...
![Some schools were getting mapped outside US](IncorrectLatitudeAndLongitudeSeenOnTableau_1.png)
...
ggplot(data=School_cnt_bar_data) +
  geom_bar(aes(x=state, y=Num_of_schools, fill=Vaccination), 
...
* From this dataset it is apparant that the higher the vaccination rates are, the schools are more likely to report those rates.  
